...
void QgsRasterTextureFormats::initializeFormats()
{
  if ( sInitialized )
    return;
...
bool QgsRasterTextureFormats::isFormatSupported( GLenum format )
{
...
QString QgsRasterTextureFormats::shaderType( Qgis::DataType dataType )
{
